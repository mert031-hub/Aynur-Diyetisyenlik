...
export default function FloatingButtons() {
  ...
  return (
    <>
      {/* Sticky WhatsApp Button — above mobile sticky bar */}
      <a
      ...
      {/* Scroll to top — above WhatsApp FAB */}
      {showScrollTop && (
        <button
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-100 shadow-lg px-4 py-3 flex gap-3">
        ...
        <a
          href="#iletisim"
          className="flex-1 flex items-center justify-center gap-2 min-h-[44px] py-2.5 bg-primary text-white font-semibold rounded-xl text-sm"
        >
          <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
