...
export default function About() {
  return (
    <section id="hakkimda" className="py-20 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative reveal-left">
            ...
            <div className="absolute -bottom-6 -right-4 lg:-right-8 z-20 bg-white rounded-2xl p-5 shadow-xl border border-gray-100 w-44">
              <div className="flex items-center gap-2 mb-1">
                <div className="w-3 h-3 rounded-full bg-primary" />
                <span className="text-xs font-semibold text-text-muted uppercase tracking-wide">Deneyim</span>
              </div>
              <div className="font-heading font-bold text-3xl text-text">10+</div>
              <div className="text-sm text-text-muted">Yıl uzman hizmet</div>
            </div>

            {/* Decorative green blob */}
            <div className="absolute -top-6 -left-6 w-48 h-48 rounded-full bg-primary/8 -z-10" />
